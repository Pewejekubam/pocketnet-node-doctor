...
ssh_rig "
  ...
  REFERENCE_RIG_CPU_WEIGHT='${REFERENCE_RIG_CPU_WEIGHT:-20}'
  REFERENCE_RIG_IO_WEIGHT='${REFERENCE_RIG_IO_WEIGHT:-10}'
  REFERENCE_RIG_MEMORY_HIGH='${REFERENCE_RIG_MEMORY_HIGH:-4G}'
  REFERENCE_RIG_MEMORY_MAX='${REFERENCE_RIG_MEMORY_MAX:-8G}'
